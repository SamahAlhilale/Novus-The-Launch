                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(spacing: 0) {
                            ...
                            VStack(alignment: .leading, spacing: 12) {
                                TextField("motto", text: $userData.userMotto)
                        ...
                        .background(GeometryReader { geo in
                            Color.clear.preference(
                                key: ThirdScrollOffsetPreferenceKey.self,
                                value: geo.frame(in: .named("scroll")).minY
                            )
                        })
                    }
                    .coordinateSpace(name: "scroll")
                    .onPreferenceChange(ThirdScrollOffsetPreferenceKey.self) { value in
                        scrollOffset = value
...
struct ThirdScrollOffsetPreferenceKey: PreferenceKey {
...
struct thirdinterface_Previews: PreviewProvider {
